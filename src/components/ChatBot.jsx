...
const ChatBot = () => {
    ...
    return (
        <div className="font-barlow">
            ...
            <div
                className={`fixed sm:right-[90px] w-full sm:w-[350px] h-[100vh] sm:h-[500px] bg-white sm:rounded-xl shadow-xl flex flex-col z-[999] transition-all duration-200 ease-in-out ${open ? "opacity-100 bottom-0" : "-bottom-full opacity-50 pointer-events-none"}`}
            >
